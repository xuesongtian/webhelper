  ...
  return (
    <button
      ...
      className={clsx(
        ...
        variant === "primary" && "bg-[#409eff] text-white shadow-[0_12px_28px_rgba(64,158,255,0.24)] hover:bg-[#337ecc]",
        ...
        variant === "danger" && "bg-[#f56c6c] text-white shadow-[0_12px_28px_rgba(245,108,108,0.18)] hover:bg-[#dd6161]",
